...
class $AssetsIconsGen {
  ...
  /// List of all assets
  List<SvgGenImage> get values => [clock, menu, notify, star];
}

class $AssetsImagesGen {
  const $AssetsImagesGen();

  /// File path: assets/images/image_ai.png
  AssetGenImage get imageAi =>
      const AssetGenImage('assets/images/image_ai.png');

  /// File path: assets/images/images.jpeg
  AssetGenImage get images => const AssetGenImage('assets/images/images.jpeg');

  /// List of all assets
  List<AssetGenImage> get values => [imageAi, images];
}
